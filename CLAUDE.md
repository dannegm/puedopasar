...
### Documentación
`CLAUDE.md` y `AGENTS.md` se mantienen en sincronía — mismo contenido, uno para Claude Code y el otro para otros asistentes IA. Al actualizar uno, aplicar los mismos cambios al otro. Las únicas diferencias intencionales son: el título, la línea de intro, y la auto-referencia en esta tabla (`CLAUDE.md` vs `AGENTS.md`).
